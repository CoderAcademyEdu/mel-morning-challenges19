...
# 3. When the user has more than 3/4 of their money left, inform them in green output of the amount remaining (using colorize). If they have 1/2 to 3/4 use blue, 1/4 to a half, yellow, and less than 1/4 left use red.